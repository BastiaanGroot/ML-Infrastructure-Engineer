...
- Tracking endpoint (private, VPC-internal only — reachable from the mk8s
  cluster/nodes, not from the public internet):
  `private-tracking.mlflow-e00ftrrk77f3v3ybbj.backbone-e00tyaqmja4khghyam.msp.eu-north1.nebius.cloud`
